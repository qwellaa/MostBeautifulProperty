...
public final class URLValues {
    ...
    // 第一页 画报
    private static final String MAGAZINE_HEAD_URL = "http://design.zuimeia.com/api/v1/articles/daily/simple/?page=";
    private static final String MAGAZINE_TAIL_URL = "&is_new_user=false&page_size=";
    ...
    private static final String VIDEO_DETAIL_UP_URL = "http://c.api.budejie.com/topic/comment_list/";
    private static final String VIDEO_DERAIL_DOWN_URL = "/0/budejie-android-6.5.7/0-20.json";
